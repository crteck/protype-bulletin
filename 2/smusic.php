...
<!-- Spoken word -->
  ...
  <div style="text-align: center;  ">
   ...
   $servername = "gator4301.hostgator.com";
    ...
    $resultDescription1 = $conn->query($sqlDescriptionQuery1);

    if ($resultDescription1->num_rows > 0) {
        // output data of each row
        while($row = $resultDescription1->fetch_assoc()) {
            echo '<p>'.$row[$sqlDescriptionVar1].'</p>';
        }
    } else {
        echo "0" . $sqlDescriptionVar1 . "results";
    }
  ...
  <div style="text-align: right; position: relative;  bottom: 15px;">
  <?php
